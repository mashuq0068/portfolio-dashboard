...
const ManageProjects = () => {
  ...
  return (
    <div className="mb-8">
      <SectionHeader title={"Manage Projects"} />

      <div className="wrapper">
        <div className="w-full mb-6">
          <div className="flex justify-between items-end gap-3 flex-wrap">
            <h2 className="text-base font-medium mb-2">All Projects List</h2>
            <Link to="/project/create-project" className="btn-primary mb-3 text-[14px]">
                     ...
                     <td className="py-4">
                        {
                          <p className="flex gap-3 items-center">
                            <img className="w-8 h-8 rounded-lg object-contain" src={project.image} alt="" />
